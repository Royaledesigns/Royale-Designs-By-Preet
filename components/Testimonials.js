  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        <p className="uppercase tracking-[0.3em] text-gold text-xs mb-3">Customer Love</p>
        <h2 className="font-serif text-3xl text-forest-dark">What Our Customers Are Saying</h2>
        <p className="text-sm text-forest/60 mt-2">Real reviews from real customers on Google.</p>
      </div>
